...
const Cart = () => {
  ...
  const removeProduct = () => {
    return <div className=' h-[55vh] flex justify-center items-center text-4xl '>장바구니가 비었습니다.</div>
  }
  ...
  return (
    <div className="container mx-auto mt-10">
      ...
      <div className="font-semibold hover:text-red-500 text-gray-500 text-4xl cursor-pointer" onClick={() => cartempty()}>장바구니 비우기</div>
